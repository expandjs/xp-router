...
(function (global){
!function(e){"use strict";var t=_dereq_("path-to-regexp"),i=e.XP||_dereq_("expandjs"),r=i.isBrowser()?_dereq_("director/build/director"):_dereq_("director"),n=i.isBrowser()?e.Router:r.http.Router;module.exports=e.XPRouter=new i.Class("XPRouter",{initialize:function(e){var t=this;t._adaptee=new n,t._server=i.isBrowser()?null:e,t._adaptee.configure({recurse:!1}),t._server&&t._server.on("request",t._handleRequest.bind(t))},init:function(){var e=this;return!e.initialized&&i.isBrowser()&&e._adaptee.init(),e.initialized=!0},on:function(e,r,n){i.isFunction(r)&&(n=r,r="GET"),i.assertArgument(i.isString(e,!0),1,"string"),i.assertArgument(i.isString(r,!0),2,"string"),i.assertArgument(i.isFunction(n),3,"Function");var s=this,u=[];return s.initialized?s:(u=i.pluck(t(e,u)&&u,"name"),r=i.isBrowser()?"on":r.toLowerCase(),i.isBrowser()?s._adaptee[r](e,function(){n(i.zipObject(u,arguments))}):s._adaptee[r](e,function(){n(i.assign(this.req,{params:i.zipObject(u,arguments)}),this.res)}),s)},initialized:{set:function(e){return this.initialized||!!e}},route:{get:function(){return this.initialized&&this._adaptee.getRoute()||null}},_adaptee:{enumerable:!1,set:function(e){return this._adaptee||e},validate:function(e){return!i.isObject(e)&&"Object"}},_server:{enumerable:!1,set:function(e){return i.isDefined(this._server)?this._server:e},validate:function(e){return!i.isBrowser()&&!i.isObject(e)&&"Object"}},_handleRequest:function(e,t){var r=this,n=[];e.on("data",function(e){n.push(e)}),e.on("end",function(){e.body=i.join(n)}),r._adaptee.dispatch(e,t,function(){t.writeHead(404),t.end()})}})}("undefined"!=typeof window?window:global);
