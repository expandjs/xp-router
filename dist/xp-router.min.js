...
(function (global){
!function(e){"use strict";var t=_dereq_("path-to-regexp"),i=e.XP||_dereq_("expandjs"),n=i.isBrowser()?_dereq_("director/build/director"):_dereq_("director"),r=i.isBrowser()?e.Router:n.http.Router;module.exports=e.XPRouter=new i.Class("XPRouter",{initialize:function(e){var t=this;t._adaptee=new r,t._server=i.isBrowser()?null:e,t._adaptee.configure({recurse:!1}),t._server&&t._server.on("request",t._handleRequest.bind(t))},init:function(){var e=this;return!e.initialized&&i.isBrowser()&&e._adaptee.init(),e.initialized=!0},on:function(e,n,r){i.isFunction(n)&&(r=n,n="GET"),i.assertArgument(i.isString(e,!0),1,"string"),i.assertArgument(i.isString(n,!0),2,"string"),i.assertArgument(i.isFunction(r),3,"Function");var s=this,a=[];return s.initialized?s:(a=i.pluck(t(e,a)&&a,"name"),n=i.isBrowser()?"on":n.toLowerCase(),i.isBrowser()?s._adaptee[n](e,function(){r(i.zipObject(a,arguments))}):s._adaptee[n](e,function(){r(i.assign(this.req,{params:i.zipObject(a,arguments)}),this.res)}),s)},initialized:{set:function(e){return this.initialized||!!e}},route:{get:function(){return this.initialized&&this._adaptee.getRoute()||null}},_adaptee:{enumerable:!1,set:function(e){return this._adaptee||e},validate:function(e){return!i.isObject(e)&&"Object"}},_server:{enumerable:!1,set:function(e){return i.isDefined(this._server)?this._server:e},validate:function(e){return!i.isBrowser()&&!i.isObject(e)&&"Object"}},_handleRequest:function(e,t){var n=this,r=[];e.on("data",function(e){r.push(e)}),e.on("end",function(){e.body=i.join(r)}),n._adaptee.dispatch(e,t,function(){var e='{"code":404,"message":"Not Found"}';t.writeHead(404,{"content-length":e.length,"content-type":"application/json;charset=utf-8"}),t.end(e)})}})}("undefined"!=typeof window?window:global);
