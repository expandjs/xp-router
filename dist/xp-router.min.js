...
(function (global){
!function(e){"use strict";var n=_dereq_("path-to-regexp"),r=e.XP||_dereq_("expandjs"),t=r.isBrowser()?_dereq_("director/build/director"):_dereq_("director"),i=r.isBrowser()?t.Router:t.http.Router;module.exports=e.XPRouter=new r.Class("XPRouter",{initialize:function(e){var n=this;n._adaptee=new i,n._server=r.isBrowser()?null:e,n._adaptee.configure({recurse:!1}),n._server&&n._server.on("request",n._handleRequest.bind(n))},on:function(e,t,i){r.isFunction(t)&&(i=t,t="GET"),r.assertArgument(r.isString(e,!0),1,"string"),r.assertArgument(r.isString(t,!0),2,"string"),r.assertArgument(r.isFunction(i),3,"Function");var s=this,u=[];return s.running?s:(u=r.pluck(n(e,u)&&u,"name"),t=r.isBrowser()?"on":t.toLowerCase(),r.isBrowser()?s._adaptee[t](e,function(){i(r.zipObject(u,arguments))}):s._adaptee[t](e,function(){i(r.assign(this.req,{params:r.zipObject(u,arguments)}),this.res)}),s)},run:function(){var e=this;return!e.running&&r.isBrowser()&&e._adaptee.init("/"),e.running=!0},route:{get:function(){return this.running&&this._adaptee.getRoute()||null}},running:{set:function(e){return this.running||!!e}},_adaptee:{enumerable:!1,set:function(e){return this._adaptee||e},validate:function(e){return!r.isObject(e)&&"Object"}},_server:{enumerable:!1,set:function(e){return r.isDefined(this._server)?this._server:e},validate:function(e){return!r.isBrowser()&&!r.isObject(e)&&"Object"}},_handleRequest:function(e,n){var t=this,i=[];e.on("data",function(e){i.push(e)}),e.on("end",function(){e.body=r.join(i)}),t._adaptee.dispatch(e,n,function(){n.writeHead(404),n.end()})}})}("undefined"!=typeof window?window:global);
